...
$string['birthday:addinstance'] = 'Add a new Latest badges block';
$string['birthday:myaddinstance'] = 'Add a new Latest badges block to Dashboard';
$string['messagealt'] = 'Message icon';
